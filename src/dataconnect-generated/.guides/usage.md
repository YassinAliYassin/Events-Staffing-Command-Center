...
```ts
import { useCreateBusiness, useCreateClient, useListInvoicesByBusiness, useAddLineItem } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useListInvoicesByBusiness(listInvoicesByBusinessVars);

const { data, isPending, isSuccess, isError, error } = useAddLineItem(addLineItemVars);
...
```js
import { createBusiness, createClient, listInvoicesByBusiness, addLineItem } from '@dataconnect/generated';
...
// Operation ListInvoicesByBusiness:  For variables, look at type ListInvoicesByBusinessVars in ../index.d.ts
const { data } = await ListInvoicesByBusiness(dataConnect, listInvoicesByBusinessVars);

// Operation AddLineItem:  For variables, look at type AddLineItemVars in ../index.d.ts
